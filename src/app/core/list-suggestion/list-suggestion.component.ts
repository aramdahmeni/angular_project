...
export class ListSuggestionComponent {
  ...
  get filteredSuggestions(): Suggestion[] {
    return this.suggestions.filter(s => {
      const matchTitle = s.title.toLowerCase().includes(this.searchTitle.toLowerCase());
      const matchCategory = s.category.toLowerCase().includes(this.searchCategory.toLowerCase());
